                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center gap-6 lg:gap-8">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="tel:+918767444148" className="flex items-center gap-2 group p-1.5 rounded-lg hover:bg-blue-50 transition-all border border-transparent hover:border-blue-100">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center text-blue-600 bg-blue-50 border border-blue-100 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                </div>
                                <div className="hidden lg:flex flex-col">
                                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider leading-none mb-0.5">Call Us</span>
                                    <span className="text-xs font-black text-gray-700 group-hover:text-blue-700 transition-colors leading-none">8767444148</span>
                                </div>
                            </a>
                            <a href="https://wa.me/918390064849" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group p-1.5 rounded-lg hover:bg-green-50 transition-all border border-transparent hover:border-green-100">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[#25d366] bg-green-50 border border-green-100 group-hover:bg-[#25d366] group-hover:text-white transition-all shadow-sm">
                                ...
                                <div className="hidden lg:flex flex-col">
                                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider leading-none mb-0.5">Chat</span>
                                    <span className="text-xs font-black text-gray-700 group-hover:text-green-600 transition-colors leading-none">8390064849</span>
                                </div>
                            </a>
                        </div>
                    ...
                    <div className="flex md:hidden items-center gap-3">
                        {/* Call */}
                        <a href="tel:+91876744148" className="w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center text-gray-600 border border-gray-100">
                            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                        </a>
                        {/* WhatsApp */}
                        <a href="https://wa.me/918390064849" className="w-8 h-8 bg-green-50 rounded-lg flex items-center justify-center text-[#25d366] border border-green-100">
